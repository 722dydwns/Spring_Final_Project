...
import com.system.pos.mapper.UserMapper;
...
public class UserService {
	...
	public void getModifyUserInfo(UserBean modifyUserBean) {
		UserBean tempModifyUserBean = userMapper.getModifyUserInfo(loginUserBean.getUser_id());
	...
	public void modifyUserInfo(UserBean modifyUserBean) {
		...
		userMapper.modifyUserInfo(modifyUserBean); //업데이트 처리 
	}
